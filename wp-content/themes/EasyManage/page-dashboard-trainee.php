<?php
/*
Template Name: Trainee dashboard Page
*/
?>
       ...
       <div style="height: 50px;">
         ...
         <div class="card">
            <div class="card-content">
                <h3 style="color:#008759;font-size:25px;">Ongoing projects</h3>
                <p>Total number of ongoing projects</p>
                <div style="width: 50px; height: 50px; border-radius: 50%; background-color: red; display: flex; justify-content: center; align-items: center; color: white; font-weight: bold;">1</div>
            </div>
        </div>

        <div class="card">
        <div class="card-content">
                <h3 style="color:#008759;font-size:25px;">Completed projects</h3>
